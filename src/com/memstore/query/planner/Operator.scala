...
abstract class Operator(private val columnName: String) {
	...
	def indexCode(index: SecondaryIndex, parameter: Any, date: Date) : Set[Any]
...
case class EqualsOperator(columnName: String) extends Operator(columnName){
	...
	override def indexCode(index: SecondaryIndex, parameter: Any, date: Date) : Set[Any] = {
...
case class EmptyOperator() extends Operator(null){
  override def indexCode(index: SecondaryIndex, parameter: Any, date: Date) : Set[Any] = null
